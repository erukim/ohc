...
import { EditReportOptions } from '../../../typings';
 ...
 * @extends BaseManager
 */
export default class EditManager extends BaseManager {
  ...
  public report(error: Error, options: EditReportOptions) {
    ...
    isSend ? executer?.editReply({ embeds: [errorEmbed] }) : null;
